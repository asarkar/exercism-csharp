...
public class InternationalCallingConnoisseurTests
{
    ...
    {
        Dictionary<int, string> prePopulated = DialingCodes.GetExistingDictionary();
    ...
    {
        Dictionary<int, string> countryCodes = DialingCodes.AddCountryToEmptyDictionary(44, "United Kingdom");
        _ = Assert.Single(countryCodes);
    }
    ...
    {
        Dictionary<int, string> countryCodes = DialingCodes.AddCountryToExistingDictionary(
    ...
    {
        string countryName = DialingCodes.GetCountryNameFromDictionary(
    ...
    {
        bool exists = DialingCodes.CheckCodeExists(
            DialingCodes.GetExistingDictionary(), 55);
        Assert.True(exists);
    }
    ...
    {
        Dictionary<int, string> countryCodes = DialingCodes.UpdateDictionary(
    ...
    {
        Dictionary<int, string> countryCodes = DialingCodes.RemoveCountryFromDictionary(
    ...
    public void Longest_country_name()
    {
        ...
        string longestCountryName = DialingCodes.FindLongestCountryName(countryCodes);
    ...
    {
        string longestCountryName = DialingCodes.FindLongestCountryName(
