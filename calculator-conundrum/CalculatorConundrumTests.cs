...
public class CalculatorConundrumTests
{
    ...
    {
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => SimpleCalculator.Calculate(1, 2, "**"));
    }
    ...
    {
        _ = Assert.Throws<ArgumentNullException>(() => SimpleCalculator.Calculate(1, 2, null));
    }
    ...
    {
        _ = Assert.Throws<ArgumentException>(() => SimpleCalculator.Calculate(1, 2, ""));
    }
